...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5715553928 5104293442').split()]
...
MAX_BTN = is_enabled((environ.get('MAX_BTN', "Flase")), False)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ipapcornsupport')
...
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', -1001529577466))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001529577466')).split()]
